    ...
    >
      ...
      <DialogContent>
        <Typography variant="body2" color="text.secondary" component="div" sx={{ '& p': { mb: 1.25 } }}>
          <p><strong>1. Search for a species</strong> — Use the top-bar species box to search by scientific or common name. Pick one or more taxa to load occurrences on the globe.</p>
          ...
          <p><strong>3. More filters</strong> — Open Filters for taxonomic groups, IUCN status, date range, and advanced options (e.g. country, dataset, institution). Save presets for quick reuse.</p>
