    ...
    >
      ...
      <DialogContent>
        <Typography variant="body2" color="text.secondary" component="div" sx={{ '& p': { mb: 1.25 } }}>
          <p><strong>1. Search for a species</strong> — Use the top-bar species box to search by scientific or common name. Open the down arrow for a taxonomic group (e.g. Birds, Plants), date range, IUCN status, max results, and advanced options. Save presets for quick reuse.</p>
          <p><strong>2. Pick a location</strong> — Open <strong>Location</strong> in the toolbar to search for a place (Photon / komoot), choose World or a continent, or draw a polygon, rectangle, or circle. With no region selected, occurrences use the camera bounds at the moment you apply filters; panning alone does not refetch.</p>
          ...
          <p><strong>7. Export</strong> — Use Export to save the current view as an image, or export GeoJSON, CSV, or PDF.</p>
        </Typography>
      </DialogContent>
